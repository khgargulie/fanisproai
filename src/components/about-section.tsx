...
export const AboutSection: React.FC = () => {
  const experiences = [
    ...
    "Использую ИИ в реальных проектах: помогал в разработке планов развития и IT-составляющей для 3х компаний, решил сотни задач при помощи нейронок",
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12">
          ...
          >
            ...
            <div className="bg-light-gray p-6 rounded-lg border-l-4 border-deep-blue mb-6">
              <h4 className="text-deep-blue font-semibold text-lg mb-2">Моя история</h4>
