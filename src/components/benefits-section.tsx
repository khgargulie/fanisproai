      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg opacity-90 max-w-2xl mx-auto">
            После курса ты получишь готовые промт-шаблоны и техники, которые сэкономят минимум 2 часа ежедневно. 
            ChatGPT, DeepSeek, Claude, Qwen — в курсе базовая системе, которая работает везде
          </p>
        </div>
