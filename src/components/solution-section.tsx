      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-text-gray max-w-2xl mx-auto">
            Технологии должны освобождать, а не порабощать. Наш курс — это путь к интеллектуальной, 
            временной и финансовой свободе через осознанное использование искусственного интеллекта.
          </p>
        </div>
